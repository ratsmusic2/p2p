<x-app-layout>
    ...
    <div class="breadcrumb mb-4">
        <p class="text-sm text-gray-500"><span class="mr-2">Pages</span> / <span class="text-white ml-2">Exchange OkEx</span></p>
        <h1 class="text-xl font-semibold my-2">Exchange OkEx</h1>
    </div>
    <!-- Dynamic Content -->
    <div class="content">  
        <div class="container mx-auto p-6">
            ...
            <div class="flex justify-between flex-col sm:flex-row items-center mb-6">
                <img src="{{ asset('assets/images/okx.png') }}" alt="OkEx" class="h-12">
